 ...
 Feature: Register_alani_deneme
  Background: Sayfa_acilisi
    ...
    And  kullanici signin username "username" girer
    And  kullanici signin password "password" girer
    And  kullanici signin remember-me checkbox i tiklar
    And  kullanici signin butonuna tiklar
    And  kullanici error mesaji iceren alerti goruntuler
